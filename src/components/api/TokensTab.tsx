...
export default function TokensTab({ baseUrl, openApiJson, mcpSpec }: Props) {
  ...
  return (
    <div className="api-tab-content">
      ...
      <section className="api-section">
        <div className="api-section-header">
          <span className="api-section-icon amber">
            <KeyIcon />
          </span>
          <h2>API Tokens</h2>
        </div>
        <p className="api-hint">
          Tokens are stored server-side and work for both the REST API and MCP Server. The token
          value is only shown once upon creation.
        </p>
        ...
        <div className="api-token-form">
          ...
          <div className="form-group">
            ...
            <div className="api-scope-hierarchy">
              ...
              <div className="api-scope-hierarchy-item">
                <strong>Write</strong> &mdash; Read + write access (POST, PATCH, DELETE)
              </div>
              <div className="api-scope-hierarchy-item">
                <strong>Admin</strong> &mdash; Full access including token management (implies all
                scopes)
              </div>
              <div className="api-scope-hierarchy-item">
        ...
        {newlyCreated && (
          <div className="api-new-token-banner">
            ...
            <p className="api-hint">
              The token value is only shown this one time. Copy and store it securely.
            </p>
                ...
                <div className="api-token-info">
                  ...
                  <div className="api-token-scopes">
                    {token.scopes.map((scope) => (
                      <span key={scope} className="api-scope-badge">
                        {SCOPE_LABELS[scope]}
                      </span>
                    ))}
                  </div>
