...
/**
 * Octicon-style download icon (tray + downward arrow).
 *
 * Shared by the stash viewer's per-file download button and the version
 * history's, so saving the current file and saving an older revision of it
