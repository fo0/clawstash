...
8. **Target ~4,000 chars** -- Past 8,000, completed items haven't been cleaned: delete resolved entries, promote 3+-session survivors to MEMORY.md, archive the remainder (`agent_docs/context_budget.md`).
...
{Only present once something was archived. One line per archive file.}

- `agent_docs/memory_archive/{YYYY-MM}.md` -- {what's in it} (archived {date})
```
