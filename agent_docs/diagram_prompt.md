...
1. Read the file tree. Exclude: `.git`, `node_modules`, `.next`, `dist`, `data`, `.idea`, `.vscode` — this stack's build output, dependency, cache and runtime-data directories (`.gitignore`).
