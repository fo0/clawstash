...
<one single-line handoff prompt for the option you recommend — CLAUDE.md → *Handoff Prompt*>
```
...
"What would you like?" is a run that ended on nothing (CLAUDE.md → *Autonomy*). Same 3-attempt cap, same snapshot,
different landing:
